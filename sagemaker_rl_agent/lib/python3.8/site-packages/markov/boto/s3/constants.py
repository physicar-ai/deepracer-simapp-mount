...
# Note: simtrace path is now constructed in rollout_worker.py with worker name
# e.g., training-simtrace/main/{}-iteration.csv, training-simtrace/sub1/{}-iteration.csv
# Modified for physicar: simplified evaluation path structure
# Video and simtrace saved directly to evaluation folder with fixed names
SIMTRACE_EVAL_S3_POSTFIX = "simtrace.json"
SIMTRACE_TRAINING_S3_POSTFIX = "{}-iteration.json"  # training-simtrace removed (added by rollout_worker)
CAMERA_PIP_MP4_S3_POSTFIX = "video.mp4"
...
SIMTRACE_EVAL_LOCAL_PATH_FORMAT = os.path.join(CUSTOM_FILES_PATH,
                                               "iteration_data/{}/evaluation-simtrace/iteration.json")
SIMTRACE_TRAINING_LOCAL_PATH_FORMAT = os.path.join(CUSTOM_FILES_PATH,
                                                   "iteration_data/{}/training-simtrace/iteration.json")
...
####### for episode data #######
# Modified for physicar: simplified evaluation path structure
SIMTRACE_EPISODE_EVAL_S3_POSTFIX = "simtrace/{}-episode.json"
SIMTRACE_EPISODE_TRAINING_S3_POSTFIX = "{}-episode.json"  # training-simtrace removed (added by rollout_worker)

# episode-wise simtrace local path
SIMTRACE_EPISODE_EVAL_LOCAL_PATH_FORMAT = os.path.join(CUSTOM_FILES_PATH,
                                               "episode_data/{}/evaluation-simtrace/episode.json")
SIMTRACE_EPISODE_TRAINING_LOCAL_PATH_FORMAT = os.path.join(CUSTOM_FILES_PATH, 
                                                  "episode_data/{}/training-simtrace/episode.json")
