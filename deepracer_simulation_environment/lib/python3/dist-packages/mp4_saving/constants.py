...
class Mp4Parameter(Enum):
    ...
    Extends:
        Enum
    """
    # Using mp4v codec - will be converted to H.264 via ffmpeg for web playback
...
class XYPixelLoc(Enum):
    ...
    SINGLE_AGENT_DISPLAY_NAME_LOC = (10, 3)
    SPEED_LEADERBOARD_LOC = (10, 300)
    SPEED_EVAL_LOC = (10, 310)
    LEADERBOARD_NAME_LOC = (10, 320)
    RACE_TYPE_EVAL_LOC = (10, 330)
    RACE_TYPE_RACE_LOC = (10, 340)
    AWS_DEEPRACER_WATER_MARK_LOC = (330, 335)
    TRAINING_PHASE_LOC = (30, 295)
