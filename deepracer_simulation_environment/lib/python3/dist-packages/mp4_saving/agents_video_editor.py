...
class AgentsVideoEditor(object):
    ...
    def __init__(self, racecar_name, racecars_info, is_publish_to_kvs_stream):
        ...
        # Modified for physicar: Save only PIP camera (most useful view)
        # 45-degree and topview cameras are disabled to simplify output
    ...
    def unsubscribe_to_save_mp4(self, req):
        ...
        """
        self.is_save_mp4_enabled = False
        # Modified for physicar: Only PIP camera is used, simplified unsubscribe logic
        # No cameras need to stop immediately since we only have PIP
        camera_topics_stop_immediately = []
