...
# Modified for physicar: simplified video path (no camera-pip subfolder)
CAMERA_PIP_MP4_LOCAL_PATH_FORMAT = os.path.join(CUSTOM_FILES_PATH,
                                                "iteration_data/{}/video.mp4")
...
def get_cameratype_params(racecar_name, agent_name, is_f1_race_type):
    ...
    # Modified for physicar: only create pip folder (others not used)
    create_folder_path([camera_pip_path])
