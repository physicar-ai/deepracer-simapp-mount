...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VideoMetricsSrv-request>)))
  ...
  "4cd2038b40793a764d97ce9d17ac1e2e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VideoMetricsSrv-request)))
  "Returns md5sum for a message object of type 'VideoMetricsSrv-request"
  "4cd2038b40793a764d97ce9d17ac1e2e")
...
(cl:defclass <VideoMetricsSrv-response> (roslisp-msg-protocol:ros-message)
  ((lap_counter
   ...
   (reset_counter
    ...
    :type cl:integer
    :initform 0)
   (obstacle_reset_counter
    :reader obstacle_reset_counter
    :initarg :obstacle_reset_counter
    :type cl:integer
    :initform 0)
   (speed
    :reader speed
   ...
   (best_lap_time
    ...
    :initform 0.0)
   (last_lap_time
    :reader last_lap_time
    :initarg :last_lap_time
    :type cl:float
    :initform 0.0)
...
(cl:ensure-generic-function 'obstacle_reset_counter-val :lambda-list '(m))
(cl:defmethod obstacle_reset_counter-val ((m <VideoMetricsSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepracer_simulation_environment-srv:obstacle_reset_counter-val is deprecated.  Use deepracer_simulation_environment-srv:obstacle_reset_counter instead.")
  (obstacle_reset_counter m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <VideoMetricsSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepracer_simulation_environment-srv:speed-val is deprecated.  Use deepracer_simulation_environment-srv:speed instead.")
  (speed m))
...
(cl:ensure-generic-function 'last_lap_time-val :lambda-list '(m))
(cl:defmethod last_lap_time-val ((m <VideoMetricsSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deepracer_simulation_environment-srv:last_lap_time-val is deprecated.  Use deepracer_simulation_environment-srv:last_lap_time instead.")
  (last_lap_time m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VideoMetricsSrv-response>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'obstacle_reset_counter)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'best_lap_time))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'last_lap_time))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VideoMetricsSrv-response>) istream)
  "Deserializes a message object of type '<VideoMetricsSrv-response>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'obstacle_reset_counter) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'last_lap_time) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VideoMetricsSrv-response>)))
  ...
  (cl:format cl:nil "float32 lap_counter~%float32 completion_percentage~%int32 reset_counter~%int32 obstacle_reset_counter~%float32 speed~%float32 throttle~%float32 steering~%float32 best_lap_time~%float32 last_lap_time~%float32 total_evaluation_time~%bool done~%float32 x~%float32 y~%geometry_msgs/Point32[] object_locations~%string episode_status~%float32 pause_duration~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VideoMetricsSrv-response)))
  "Returns full string definition for message of type 'VideoMetricsSrv-response"
  (cl:format cl:nil "float32 lap_counter~%float32 completion_percentage~%int32 reset_counter~%int32 obstacle_reset_counter~%float32 speed~%float32 throttle~%float32 steering~%float32 best_lap_time~%float32 last_lap_time~%float32 total_evaluation_time~%bool done~%float32 x~%float32 y~%geometry_msgs/Point32[] object_locations~%string episode_status~%float32 pause_duration~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VideoMetricsSrv-response>))
  ...
  (cl:list 'VideoMetricsSrv-response
    ...
    (cl:cons ':obstacle_reset_counter (obstacle_reset_counter msg))
    (cl:cons ':speed (speed msg))
    (cl:cons ':throttle (throttle msg))
    (cl:cons ':steering (steering msg))
    (cl:cons ':best_lap_time (best_lap_time msg))
    (cl:cons ':last_lap_time (last_lap_time msg))
