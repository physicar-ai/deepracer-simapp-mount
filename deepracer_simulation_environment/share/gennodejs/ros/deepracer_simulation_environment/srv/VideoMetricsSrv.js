...
class VideoMetricsSrvResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.obstacle_reset_counter = null;
      this.speed = null;
      this.throttle = null;
      this.steering = null;
      this.best_lap_time = null;
      this.last_lap_time = null;
      ...
      if (initObj.hasOwnProperty('obstacle_reset_counter')) {
        this.obstacle_reset_counter = initObj.obstacle_reset_counter
      }
      else {
        this.obstacle_reset_counter = 0;
      }
      ...
      if (initObj.hasOwnProperty('last_lap_time')) {
        this.last_lap_time = initObj.last_lap_time
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [obstacle_reset_counter]
    bufferOffset = _serializer.int32(obj.obstacle_reset_counter, buffer, bufferOffset);
    ...
    // Serialize message field [last_lap_time]
    bufferOffset = _serializer.float32(obj.last_lap_time, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [obstacle_reset_counter]
    data.obstacle_reset_counter = _deserializer.int32(buffer, bufferOffset);
    ...
    // Deserialize message field [last_lap_time]
    data.last_lap_time = _deserializer.float32(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.episode_status);
    return length + 61;
  }
  ...
  static md5sum() {
    //Returns md5sum for a message object
    return '4cd2038b40793a764d97ce9d17ac1e2e';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.obstacle_reset_counter !== undefined) {
      resolved.obstacle_reset_counter = msg.obstacle_reset_counter;
    }
    else {
      resolved.obstacle_reset_counter = 0
    }
    ...
    if (msg.last_lap_time !== undefined) {
      resolved.last_lap_time = msg.last_lap_time;
    }
    else {
      resolved.last_lap_time = 0.0
    }
...
module.exports = {
  ...
  md5sum() { return '4cd2038b40793a764d97ce9d17ac1e2e'; },
