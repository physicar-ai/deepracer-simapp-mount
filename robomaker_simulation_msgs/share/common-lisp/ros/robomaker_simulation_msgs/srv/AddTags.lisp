...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddTags-request>)))
  ...
  (cl:format cl:nil "# Copyright 2019 Amazon.com, Inc. or its affiliates. All Rights Reserved.~%# SPDX-License-Identifier: Apache-2.0~%#~%# This service is loaded at runtime in AWS RoboMaker simulations.~%#~%# Calling this service will set tags on the running simulation~%# job.~%#~%# More information about usage can be found here:~%# https://docs.aws.amazon.com/robomaker~%#~%# This uses the TagResourceAPI:~%# https://docs.aws.amazon.com/robomaker/latest/dg/API_TagResource.html~%~%# List of key:value pairs to set as tags on the simulation job.~%Tag[] tags~%~%================================================================================~%MSG: robomaker_simulation_msgs/Tag~%# Copyright 2019 Amazon.com, Inc. or its affiliates. All Rights Reserved.~%# SPDX-License-Identifier: Apache-2.0~%string key~%string value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddTags-request)))
  "Returns full string definition for message of type 'AddTags-request"
  (cl:format cl:nil "# Copyright 2019 Amazon.com, Inc. or its affiliates. All Rights Reserved.~%# SPDX-License-Identifier: Apache-2.0~%#~%# This service is loaded at runtime in AWS RoboMaker simulations.~%#~%# Calling this service will set tags on the running simulation~%# job.~%#~%# More information about usage can be found here:~%# https://docs.aws.amazon.com/robomaker~%#~%# This uses the TagResourceAPI:~%# https://docs.aws.amazon.com/robomaker/latest/dg/API_TagResource.html~%~%# List of key:value pairs to set as tags on the simulation job.~%Tag[] tags~%~%================================================================================~%MSG: robomaker_simulation_msgs/Tag~%# Copyright 2019 Amazon.com, Inc. or its affiliates. All Rights Reserved.~%# SPDX-License-Identifier: Apache-2.0~%string key~%string value~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddTags-response>)))
  ...
  (cl:format cl:nil "# True if tags were successfully set. False otherwise.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddTags-response)))
  "Returns full string definition for message of type 'AddTags-response"
  (cl:format cl:nil "# True if tags were successfully set. False otherwise.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%~%"))
