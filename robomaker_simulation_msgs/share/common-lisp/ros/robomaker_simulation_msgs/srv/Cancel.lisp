...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Cancel-response>)))
  ...
  (cl:format cl:nil "# True if the cancellation request was successful.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Cancel-response)))
  "Returns full string definition for message of type 'Cancel-response"
  (cl:format cl:nil "# True if the cancellation request was successful.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%~%"))
