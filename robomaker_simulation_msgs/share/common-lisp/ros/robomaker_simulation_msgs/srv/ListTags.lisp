...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ListTags-response>)))
  ...
  (cl:format cl:nil "# True if tags were successfully fetched. False otherwise.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%# The tags associated with the simulation provided as~%# key:value pairs.~%Tag[] tags~%~%================================================================================~%MSG: robomaker_simulation_msgs/Tag~%# Copyright 2019 Amazon.com, Inc. or its affiliates. All Rights Reserved.~%# SPDX-License-Identifier: Apache-2.0~%string key~%string value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ListTags-response)))
  "Returns full string definition for message of type 'ListTags-response"
  (cl:format cl:nil "# True if tags were successfully fetched. False otherwise.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%# The tags associated with the simulation provided as~%# key:value pairs.~%Tag[] tags~%~%================================================================================~%MSG: robomaker_simulation_msgs/Tag~%# Copyright 2019 Amazon.com, Inc. or its affiliates. All Rights Reserved.~%# SPDX-License-Identifier: Apache-2.0~%string key~%string value~%~%"))
