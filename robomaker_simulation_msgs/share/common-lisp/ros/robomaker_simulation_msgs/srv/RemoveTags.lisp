...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RemoveTags-response>)))
  ...
  (cl:format cl:nil "# True if tags were successfully removed. False otherwise.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RemoveTags-response)))
  "Returns full string definition for message of type 'RemoveTags-response"
  (cl:format cl:nil "# True if tags were successfully removed. False otherwise.~%bool success~%~%# Message containing more information about the error if success~%# is false.~%string message~%~%~%"))
